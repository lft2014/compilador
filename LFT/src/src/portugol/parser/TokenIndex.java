...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTEsqParen(@SuppressWarnings("unused") TEsqParen node)
    {
        this.index = 36;
    }

    @Override
    public void caseTDirParen(@SuppressWarnings("unused") TDirParen node)
    {
        this.index = 37;
    }

    @Override
    public void caseTAspaD(@SuppressWarnings("unused") TAspaD node)
    {
        this.index = 38;
    }
    ...
    @Override
    public void caseTEsqColchete(@SuppressWarnings("unused") TEsqColchete node)
    {
        this.index = 40;
    }

    @Override
    public void caseTDirColchete(@SuppressWarnings("unused") TDirColchete node)
    {
        this.index = 41;
    }
