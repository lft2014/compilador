...
public final class AComandoParaPasso extends PComandoParaPasso
{
    ...
    private PComplementoPara2 _complementoPara2_;
    private TAte _ate_;
    ...
    public AComandoParaPasso(
        ...
        @SuppressWarnings("hiding") PComplementoPara2 _complementoPara2_,
        ...
        @SuppressWarnings("hiding") TPontoevirgula _pontoevirgula_)
    {
        ...
        setComplementoPara2(_complementoPara2_);
    ...
    {
        ((Analysis) sw).caseAComandoParaPasso(this);
    }
    ...
    public PComplementoPara2 getComplementoPara2()
    {
        return this._complementoPara2_;
    }

    public void setComplementoPara2(PComplementoPara2 node)
    {
        if(this._complementoPara2_ != null)
        {
            this._complementoPara2_.parent(null);
        }
    ...
    public String toString()
    {
        return ""
            ...
            + toString(this._complementoPara2_)
            + toString(this._ate_)
    ...
    void removeChild(@SuppressWarnings("unused") Node child)
    {
        ...
        if(this._complementoPara2_ == child)
        {
            this._complementoPara2_ = null;
            return;
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        if(this._complementoPara2_ == oldChild)
        {
            setComplementoPara2((PComplementoPara2) newChild);
            return;
        }
